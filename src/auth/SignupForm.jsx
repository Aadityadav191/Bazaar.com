            ...
            >
              <div className="mb-4">
                <input
                  ...
                  aria-label="Name"
                  placeholder="Name"
                  className={`text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border ${
              ...
              <div className="min-h-6 pl-7 mb-0.5 block">
                <input
                  type="checkbox"
                  id="terms"
                  className="w-5 h-5 ease-soft -ml-7 rounded-1.4 checked:bg-gradient-to-tl checked:from-gray-900 checked:to-slate-800 after:duration-250 after:ease-soft-in-out duration-250 relative float-left mt-1 cursor-pointer appearance-none border border-solid border-slate-200 bg-white bg-contain bg-center bg-no-repeat align-top transition-all checked:border-0 checked:border-transparent checked:bg-transparent checked:after:opacity-100"
                  {...register("terms", {
                ...
                >
                  I agree the{" "}
                  <a className="font-bold text-green-500" href="#">
