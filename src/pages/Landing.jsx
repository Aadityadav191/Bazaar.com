    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex justify-between items-end mb-12">
          ...
          <a
            href="#"
            className="hidden sm:flex items-center text-indigo-600 font-bold hover:gap-2 transition-all"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((cat) => (
            <div
              key={cat.id}
              className="group relative h-80 overflow-hidden rounded-3xl bg-gray-200 cursor-pointer shadow-sm"
            >
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-3xl font-bold mb-12 tracking-tight text-center sm:text-left">
            Trending Items
          </h3>
              ...
              >
                <div className="relative aspect-[4/5] rounded-2xl bg-gray-50 overflow-hidden mb-5">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/600x800?text=Lumina+Product";
                    }}
                  />
